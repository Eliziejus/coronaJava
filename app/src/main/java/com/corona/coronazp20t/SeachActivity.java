    ...
    private class AsyncFetch extends AsyncTask<String, String, JSONObject>{
        ...
        protected JSONObject doInBackground(String... params) {
            try{
                ...
                Toast.makeText(
                        SeachActivity.this,
                        getResources().getText(R.string.search_error_reading) + e1.getMessage(),
                        Toast.LENGTH_LONG
                ).show();
                return null;
            }
        ...
        protected void onPostExecute(JSONObject json) {
         //this method will be running on UI thread
            ...
            try{
                ...
                Toast.makeText(
                        SeachActivity.this,
                        getResources().getText(R.string.search_error_reading) + e.getMessage(),
                        Toast.LENGTH_LONG
                        ).show();
            }
            if(statusCode==HttpURLConnection.HTTP_OK){
                ...
                try{
                    ...
                    Toast.makeText(
                            SeachActivity.this,
                            getResources().getText(R.string.search_error_reading) + message,
                            Toast.LENGTH_LONG
                    ).show();
                }
